...
struct ImGuiBoxSelectState
{
    ...
    ImRect                  UnclipRect;         // rlRectangle where ItemAdd() clipping may be temporarily disabled. Need support by multi-select supporting widgets.
...
struct ImGuiContext
{
    ...
    ImRect                  NavScoringRect;                     // rlRectangle used for scoring, in screen space. Based of window->NavRectRel[], modified for directional navigation scoring.
